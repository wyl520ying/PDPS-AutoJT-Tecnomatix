...
{
    public class AJTTxMessageHandling
    {
        ...
        public void AddErrorDistinct(string message, string line)
        {
            if (!this.Errors.ContainsKey(message) || !this.Errors[message].Contains(line))
            {
                this.AddError(this.Errors, message, line);
            }
        }
