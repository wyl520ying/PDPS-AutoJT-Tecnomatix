...
namespace AutoJTTXUtilities.AJTLoadingHandling
{
    public class HelpWin32
    {
        ...
        public static extern IntPtr FindWindow2(string lpClassName, string lpWindowName);
        [DllImport("user32.dll", CharSet = CharSet.Auto)]
        ...
        /// </summary>
        /// <returns></returns>
        public static System.Diagnostics.Process GetTargetProcess(string processName)
        {
            System.Diagnostics.Process _Firstapp = null;
            //查找指定的进程 
            System.Diagnostics.Process[] CATapp = System.Diagnostics.Process.GetProcessesByName(processName);

            if (CATapp.Length == 1)
            {
                _Firstapp = CATapp.FirstOrDefault();
                return _Firstapp;
            }
