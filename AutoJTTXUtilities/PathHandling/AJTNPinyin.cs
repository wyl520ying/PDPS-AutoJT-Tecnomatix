...
namespace AutoJTTXUtilities.PathHandling
{
    ...
    public static class AJTNPinyin
    {
        public static string GetInitials(string text)
        {
            ...
            {
                string pinyin = AJTNPinyin.GetPinyin(text[i]);
                if (pinyin != "")
                {
        ...
        {
            return AJTNPinyin.ConvertEncoding(AJTNPinyin.GetInitials(AJTNPinyin.ConvertEncoding(text, encoding, Encoding.UTF8)), Encoding.UTF8, encoding);
        }
        ...
        {
            return AJTNPinyin.ConvertEncoding(AJTNPinyin.GetPinyin(AJTNPinyin.ConvertEncoding(text.Trim(), encoding, Encoding.UTF8)), Encoding.UTF8, encoding);
        }
        ...
        {
            return AJTNPinyin.ConvertEncoding(AJTNPinyin.GetChineseText(AJTNPinyin.ConvertEncoding(pinyin, encoding, Encoding.UTF8)), Encoding.UTF8, encoding);
        }

        public static string GetPinyin(char ch)
        {
            short hashIndex = AJTNPinyin.GetHashIndex(ch);
            for (int i = 0; i < PyHash.hashes[(int)hashIndex].Length; i++)
            {
                short num = PyHash.hashes[(int)hashIndex][i];
                if (PyCode.codes[(int)num].IndexOf(ch, 7) != -1)
                {
        ...
        {
            ch = AJTNPinyin.ConvertEncoding(ch.ToString(), encoding, Encoding.UTF8)[0];
            return AJTNPinyin.ConvertEncoding(AJTNPinyin.GetPinyin(ch), Encoding.UTF8, encoding);
        }
