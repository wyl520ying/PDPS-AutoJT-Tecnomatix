...
namespace AutoJTTXCoreUtilities.RobotMatrix
{
    public class AJTApGenUtils
    {
        ...
        internal static bool CalcLocationReachabilityStatus(AdjustLocationParams alParams, out AJTApRmxUtils.EApRmxReachabilityStatus reachabilityStatus)
        {
            reachabilityStatus = AJTApGenUtils.AAA_CalculateCurrentLocationStatus(alParams);
            return AJTApGenUtils.AAA_IsSuccessfulStatus(reachabilityStatus);
        }
        ...
        internal static bool IsValidLocationInSimulation(ITxRoboticLocationOperation loc)
        {
            bool flag = false;
            if (loc != null)
            {
        ...
        internal static ITxTool GetAssignedGun(ITxLocationOperation locOp)
        {
            ITxTool result = null;
            ITxRoboticLocationOperation txRoboticLocationOperation = locOp as ITxRoboticLocationOperation;
            if (txRoboticLocationOperation != null)
        ...
        public static TxLocationAvailabilityState CalculateCurrentLocationState(AdjustLocationParams alParams)
        {
            return AJTApGenUtils.CalculateLocationStateRotatedAt(alParams, 0.0);
        }

        public static TxLocationAvailabilityState CalculateLocationStateRotatedAt(AdjustLocationParams alParams, double angleRad)
        {
            TxLocationAvailability txLocationAvailability = null;
        ...
        /// <param name="alParams"></param>
        /// <returns></returns>
        public static TxLocationAvailability CreateUtility3(AdjustLocationParams alParams)
        {
            ArrayList arrayList;
            if (alParams.m_poseList == null || alParams.m_poseList.Count < 1)
            {
        ...
        public static AJTApRmxUtils.EApRmxReachabilityStatus AAA_CalculateCurrentLocationStatus(AdjustLocationParams alParams)
        {
            TxLocationAvailabilityState txLocationAvailabilityState = AJTApGenUtils.CalculateCurrentLocationState(alParams);
